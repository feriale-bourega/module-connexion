...
//on verifie que le bouton submit a bien été cliqué
if(isset($_POST['submit']))
{
    ...
    {   
        ...
        if($password==$password2)
        {
            ...
            //cette fonction compte le nombre de lignes retournées
            $row = mysqli_num_rows($regetx); //elle ne retournera que 0 ou 1 puisque on a verrouillé les doublons dans la page inscription
